    ...
    return (
        <div className='bg-[#ECECEC]'>
            ...
            <div className='md:w-9/12 mx-auto px-6 md:px-0 md:grid grid-cols-2 items-center gap-10'>
                ...
                <div>
                    <p className='font-normal text-[16px] md:text-[24px] md:leading-9 text-black md:pr-36 text-center md:text-left'>
            ...
            <div className=''>
                <Image className='-rotate-90 md:rotate-0 md:-mt-40 ml-[102px] md:ml-0' src="https://i.ibb.co/X4LQ2N7/Group-15-1.png" alt='' height={332} width={213} />
            </div>
        </div>
    );
};
