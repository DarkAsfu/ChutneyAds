...
const Advertisement = () => {
    return (
        <div data-aos="fade-up" className='bg-[#F9F9F9] pt-20 pb-10 md:pb-0'>
            <div data-aos="zoom-in-up" className='flex justify-end md:-mt-48 '>
            ...
            <div className='md:-mt-20 md:w-9/12 mx-auto  md:px-0 grid md:grid-cols-2 items-center gap-10 md:gap-32'>
                ...
                <div data-aos="zoom-in-up" className='px-6 md:px-0'>
                ...
                <div data-aos="zoom-in-up" className='order-4 md:order-3'>
                ...
                <div data-aos="zoom-in-up" className='order-3 md:order-4'>
                    <div>
            ...
            <div data-aos="zoom-in-up" className=' -mt-56 hidden md:block'>
